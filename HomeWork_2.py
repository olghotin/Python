...
result_s_root = item_1**(1./2)
# 14. Вывести result_s_root в консоль.
print('Квадратный корень переменной item_1, result_s_root =', result_s_root)
...
print('Квадратный корень из переменной item_1, библиотека math, метод sqrt, result_m_s_root =', result_m_s_root)
...
print('Квадратный корень из переменной item_1, библиотека math, метод pow, result_mp_s_root =', result_mp_s_root)
